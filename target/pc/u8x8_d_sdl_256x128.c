...
const u8x8_display_info_t u8x8_sdl_296x128_info =
{
  /* chip_enable_level = */ 0,
  /* chip_disable_level = */ 1,
  ...
  /* data_setup_time_ns = */ 0,
  /* write_pulse_width_ns = */ 0,
  /* tile_width = */ 37,		/* width of 37*8=296 pixel */
...
uint8_t u8x8_d_sdl_296x128(u8x8_t *u8g2, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  uint8_t x, y, c;
  uint8_t *ptr;
  switch(msg)
  {
    case U8X8_MSG_DISPLAY_SETUP_MEMORY:
      u8x8_d_helper_display_setup_memory(u8g2, &u8x8_sdl_296x128_info);
      u8g_sdl_init(296, 128);
      break;
    case U8X8_MSG_DISPLAY_INIT:
      u8x8_d_helper_display_init(u8g2);
      break;
...
void u8x8_Setup_SDL_296x128(u8x8_t *u8x8)
{
  /* setup defaults */
  u8x8_SetupDefaults(u8x8);

  /* setup specific callbacks */
  u8x8->display_cb = u8x8_d_sdl_296x128;
...
void u8g2_SetupBuffer_SDL_296x128(u8g2_t *u8g2, const u8g2_cb_t *u8g2_cb)
{
  static uint8_t buf[296*128/8];

  u8x8_Setup_SDL_296x128(u8g2_GetU8x8(u8g2));
