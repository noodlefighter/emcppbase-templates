...
extern uint8_t host_control_flag;
...
void
Iso15693Anticollision(uint8_t *mask, uint8_t length)		// host command 0x14
{
	...
	if((flags & BIT(5)) == 0x00)							// flag bit5 is the number of slots indicator
	{
